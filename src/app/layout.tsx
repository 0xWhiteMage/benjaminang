...
const personJsonLd = {
  ...
  name: site.name,
  url: site.url,
  jobTitle: "Creative Director / Motion Designer / Business Strategist",
  description: site.description,
  ...
  sameAs: [
    "https://www.linkedin.com/in/benjaminang",
    "https://www.instagram.com/benjaminang",
  ],
  worksFor: { "@type": "Organization", name: "Genesis" },
